...
<li class="dd-item dd3-item" data-id="{{$item["id"]}}">
    ...
    <div class="dd3-content {{$item["url"] == "javascript:;" ? "font-weight-bold" : ""}}">
        ...
        {{-- <form action="{{route('menu.eliminar', $item['id'])}}" class="form-eliminar d-inline" method="post">
            @csrf @method('delete')
            <button type="button" class="btn-accion-tabla pull-right boton-eliminar-menu" data-toggle="tooltip" title="Eliminar este menú"><i class="text-danger fa fa-fw fa-trash-o"></i></button>
        </form> --}}
    </div>
</li>
@else
